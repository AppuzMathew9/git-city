    ...
    <div className="mt-2 border-2 border-border/50 bg-bg/50 px-3 py-2">
      {isOwned ? (
        <>
          {autoUploading && (
            <div
              className="mb-2 border-2 border-dashed px-3 py-2 text-[10px] normal-case animate-pulse"
          ...
          {!autoUploading && images.filter(Boolean).length === 0 && (
            <div
              className="mb-2 border-2 border-dashed px-3 py-2 text-[10px] normal-case"
              style={{ borderColor: ACCENT, color: ACCENT }}
            >
...
export default function ShopClient({
  ...
  const [buyingProvider, setBuyingProvider] = useState<
    "stripe" | "nowpayments" | "abacatepay" | null
  >(null);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="border-[3px] border-border bg-bg p-6 text-center">
            ...
            <p className="text-xs text-cream">
              {buyingProvider === "abacatepay" ? "Generating PIX..." : "Redirecting to checkout..."}
            </p>
                        ...
                        return (
                          <div key={itemId} className="relative" data-buy-popover>
                            ...
                            {isConfirming && shopItem && (
                              <div
                                data-buy-popover
                                className="absolute left-1/2 -translate-x-1/2 top-full mt-1 z-30 w-36 border-2 border-border bg-bg p-2 shadow-lg"
                              >
                                  ...
                                  {isBrazil && (
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        setConfirmBuyItem(null);
                                        checkout(itemId, "abacatepay");
                                      }}
                                      disabled={isBuying}
                                      className="btn-press w-full py-1 text-[9px] text-bg disabled:opacity-40"
                                      style={{
                                        backgroundColor: "#32bcad",
                                        boxShadow: "1px 1px 0 0 #1a7a6e",
                                      }}
                                    >
                        ...
                        <button
                          ...
                          className={[
                            ...
                            isFacesOwned
                              ...
                              : "border-2 border-border bg-bg-card opacity-60",
                              ...
                              {isBrazil && (
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    setConfirmBuyItem(null);
                                    checkout("streak_freeze", "abacatepay");
                                  }}
                                  disabled={isBuying}
                                  className="btn-press w-full py-1 text-[9px] text-bg disabled:opacity-40"
                                  style={{
